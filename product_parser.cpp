...
{
    Book* mybook = new Book(categoryID(), prodName_, price_, qty_, isbn_, author_);
    return mybook;
}
...
{
    Clothing* mycloth = new Clothing(categoryID(), prodName_, price_, qty_, size_, brand_);
    return mycloth;
}
...
{
    Movie* mymovie = new Movie(categoryID(), prodName_, price_, qty_, genre_, rating_);
    return mymovie;
}
